...
public class HumanReadableSize {
  ...
  /**
   * 将易读的字节数转换成真实字节数。 <ul> <li><code>1</code> 转换成 <code>1</code>。</li> <li><code>1K</code> 转换成 <code>1024</code>。</li>
   * <li><code>1M</code> 转换成 <code>1048576</code>。</li> <li><code>1G</code> 转换成 <code>1073741824</code>。</li>
   * <li><code>1T</code> 转换成 <code>1099511627776</code>。</li> <li>支持小数点，例如：<code>1.5K</code>。</li> </ul>
   */
  ...
  private static long parse(String humanReadbleSize, String... nas) {
    humanReadbleSize = Preconditions.checkNotNull(StringUtils.trimToNull(humanReadbleSize),
                                                  "human readble size");
    ...
    Preconditions.checkState(matcher.matches(), "wrong format: %s", humanReadbleSize);
  ...
  /**
   * 将字节数取整，并转换成易读的概要字节数。 <ul> <li><code>1</code>转换成<code>1</code>。</li> <li><code>1024</code>转换成<code>1K</code>。</li>
   * <li><code>1048576</code>转换成<code>1M</code>。</li> <li><code>1073741824</code>转换成<code>1G</code>。</li>
   * <li><code>1099511627776</code>转换成<code>1T</code>。</li> <li>小于<code>0</code>的一律转换成<code>n/a</code>。</li> </ul>
   */
