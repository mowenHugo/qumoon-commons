...
public class MethodOverrideFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
    ...
    if ("POST".equals(request.getMethod()) && (StringUtils.hasLength(paramValue) || StringUtils
        .hasLength(headerValue))) {
  ...
  /**
   * Simple {@link javax.servlet.http.HttpServletRequest} wrapper that returns the supplied method for {@link
