...
public interface CommonConstant {
  ...
  Byte BYTE_ZERO = new Byte((byte) 0);
  Short SHORT_ZERO = new Short((short) 0);
  Integer INT_ZERO = new Integer(0);
  Long LONG_ZERO = new Long(0L);
  Float FLOAT_ZERO = new Float(0);
  Double DOUBLE_ZERO = new Double(0);
  Character CHAR_NULL = new Character('\0');
